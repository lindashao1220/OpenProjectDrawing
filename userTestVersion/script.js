...
function draw() {
    ...
    ps.addParticle(x, y, random(8, 18));
   ...
   if (averageFrequency > 100) {
    ...
    if (currTime - lastCircleTime > circleInterval) {
      //display
      innerPetal[curCircle].color = color(r,g+sin(frameCount*0.03)*20,b);
      middlePetal[curCircle].color = color(r+random(20),g-random(50),b+random(30));
      outerPetal[curCircle].color = color(r-random(20),g+random(50),b-random(30));
